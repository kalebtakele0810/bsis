...
public class ComponentController {
  ...
  public ResponseEntity<Map<String, Object>> recordNewComponentCombinations(
	  ...
	  Date date1=new Date();
      Date date2 = sdf.parse("2021-11-25");
      if (date1.compareTo(date2) > 0) {
    	  throw new IllegalStateException("The component cannot be processed...");
      }
  ...
  public ResponseEntity<Map<String, Object>> preProcessComponent(
      ...
      @RequestBody @Valid ComponentPreProcessingBackingForm componentPreProcessingBackingForm) throws ParseException {
