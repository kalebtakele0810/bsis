...
public class ReportsControllerService {
	...
	public List<DiscardReasonViewModel> getAllDiscardReasons(Boolean includeDeleted) {
		return componentStatusChangeReasonFactory
				.createDiscardReasonViewModels(discardReasonRepository.getAllDiscardReasons(includeDeleted));
	}
	...
	public List<AdverseEventTypeViewModel> getAdverseEventTypes() {
		// FIXME: the ViewModel shouldn't be returned from the Repository (although it
		// probably is quite efficient)
	...
	public List<TransfusionReactionTypeViewModel> getTransfusionReactionTypes() {
		List<TransfusionReactionType> transfusionReactionTypes = transfusionReactionTypeRepository
				.getAllTransfusionReactionTypes(false);
	...
	public List<BloodTestViewModel> getEnabledTTIBloodTests() {
		return bloodTestFactory
				.createViewModels(bloodTestRepository.getEnabledBloodTestsOfType(BloodTestType.BASIC_TTI));
	}
	...
	public int doWHOQueries(String qry) {
		return adverseEventTypeRepository.doWHOQueries(qry);
	}
	public List<Object> doDonorQueries(String qry) {
		return adverseEventTypeRepository.doDonorQueries(qry);
	}
