...
public class DonorRepository {
	...
	// added by kaleb
	public List<PreferredLanguage> getOfflineLanguages() {
		TypedQuery<PreferredLanguage> query = em.createQuery(
				"SELECT l FROM PreferredLanguage l where preferredLanguage='English'", PreferredLanguage.class);
	...
	public List<Donor> findUpdatedDonors(Date startDate, Date endDate) {
		...
		String queryString = "SELECT d FROM Donor " + "d LEFT JOIN fetch d.donations donations "
				+ "WHERE d.isDeleted = :isDeleted " + "and d.donorStatus not in :donorStatus " + "and "
				+ "("
				+ "(d.dateOfLastDonation >= :startDate " + "and d.dateOfLastDonation < :endDate )" + ")";
